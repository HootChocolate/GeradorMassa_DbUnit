...
public class TestServiceDbUnit_Conta {
	...
	/**
	 * Este teste de serviço, insere uma conta do banco,
	 * utilizado a exportação de arquivos XML do DbUnit
	 * 
	 * @throws Exception
	 */
	@Test
	public void testInserirConta() throws Exception {
		ImportExport.importarDadoParaOBanco("est4_inserirConta.xml"); // Define o cenário que o banco terá
